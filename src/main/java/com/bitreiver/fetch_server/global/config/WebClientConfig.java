...
public class WebClientConfig {
    ...
    @Bean
    public WebClient blockMediaWebClient() {
        ConnectionProvider connectionProvider = ConnectionProvider.builder("blockmedia")
            .maxConnections(20)
            .maxIdleTime(Duration.ofSeconds(10))
            .maxLifeTime(Duration.ofSeconds(60))
            .pendingAcquireTimeout(Duration.ofSeconds(10))
    ...
    @Bean
    public WebClient yahooFinanceWebClient(ObjectMapper objectMapper) {
        ConnectionProvider connectionProvider = ConnectionProvider.builder("yahoo-finance")
            .maxConnections(20)
            .maxIdleTime(Duration.ofSeconds(10))
            .maxLifeTime(Duration.ofSeconds(60))
            .pendingAcquireTimeout(Duration.ofSeconds(10))
    ...
    @Bean
    public WebClient tossInvestWebClient(ObjectMapper objectMapper) {
        ConnectionProvider connectionProvider = ConnectionProvider.builder("toss-invest")
            .maxConnections(20)
            .maxIdleTime(Duration.ofSeconds(10))
            .maxLifeTime(Duration.ofSeconds(60))
            .pendingAcquireTimeout(Duration.ofSeconds(10))
    ...
    @Bean
    public WebClient coinoneWebClient(ObjectMapper objectMapper) {
        ConnectionProvider connectionProvider = ConnectionProvider.builder("coinone")
            .maxConnections(50)
            .maxIdleTime(Duration.ofSeconds(10))
            .maxLifeTime(Duration.ofSeconds(60))
            .pendingAcquireTimeout(Duration.ofSeconds(10))
    ...
    @Bean
    public WebClient bithumbWebClient(ObjectMapper objectMapper) {
        ConnectionProvider connectionProvider = ConnectionProvider.builder("bithumb")
            .maxConnections(50)
            .maxIdleTime(Duration.ofSeconds(10))
            .maxLifeTime(Duration.ofSeconds(60))
            .pendingAcquireTimeout(Duration.ofSeconds(10))
