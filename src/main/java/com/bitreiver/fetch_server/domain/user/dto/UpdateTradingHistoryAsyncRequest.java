...
@Getter
@Schema(description = "비동기 거래내역 업데이트 요청")
public class UpdateTradingHistoryAsyncRequest {
    @Schema(description = "사용자 UUID", example = "123e4567-e89b-12d3-a456-426614174000", required = true)
    @NotBlank(message = "사용자 ID는 필수입니다.")
    @JsonProperty("user_id")
    private String userId;
    
    @Schema(description = "동기화할 거래소 목록", example = "[\"UPBIT\", \"COINONE\"]", required = true)
    @NotEmpty(message = "거래소 목록은 필수입니다.")
